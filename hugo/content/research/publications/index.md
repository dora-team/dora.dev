...
<section class="publicationHighlight">
    <aside>
        <a href="https://cloud.google.com/resources/content/2025-dora-ai-capabilities-model-report" target="_blank"><img src="/ai/capabilities-model/report/2025-dora-ai-capabilities-model-report.png" alt="DORA AI Capabilities Model report"></a>
    </aside>
    <article>
        <p>
            The DORA AI Capabilities Model report, a companion guide to the <a href="/research/2025/dora-report/">2025 State of AI-assisted Software Development report</a>, serves as a practical guide to the seven capabilities that amplify the benefits of AI. For each of the seven core capabilities, this report details implementation strategies, specific tactics for teams to get started, and methods for monitoring progress and fostering continuous improvement.
        </p>
        <p>
            <a href="https://cloud.google.com/resources/content/2025-dora-ai-capabilities-model-report" target="_blank"><button class="secondary">Download the report</button></a>
        </p>
    </article>
</section>
...
- [![DevOps Awards Winners 2021](devops_awards_fullebook.png)](https://services.google.com/fh/files/misc/devops_awards_fullebook_final.pdf)
