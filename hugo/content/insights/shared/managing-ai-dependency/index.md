...
In the first part of this research series ([AI as tutor](/ai/research-insights/ai-as-a-tutor/)), we discussed how students are using AI in their learning and coding workflows. In this article, we discuss the concerns that students have about over-reliance on AI (many of which [mirror](/ai/research-insights/concerns-beyond-accuracy-of-ai-output/) those of professional developers) and how they are modulating their AI usage.
