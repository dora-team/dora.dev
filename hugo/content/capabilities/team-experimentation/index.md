...
[visibility of work in the value stream](../work-visibility-in-value-stream),
[working in small batches](../working-in-small-batches),
and [visibility into customer feedback](../customer-feedback).
...
-   **Leave the details to those doing the work**. Allow your teams to change
    ...
    [to make informed decisions about the tools and technologies they use](../teams-empowered-to-choose-tools).
