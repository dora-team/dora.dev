...
and
[comprehensive monitoring and observability](/devops-capabilities/monitoring-and-observability)
...
*   Use peer review to meet the goal of segregation of duties, with reviews,
    ...
    [development platform](/devops-capabilities/code-maintainability)
    as part of the development process.
*   Employ [continuous testing](/devops-capabilities/test-automation),
    [continuous integration](/devops-capabilities/continuous-integration),
    and
    [comprehensive monitoring and observability](/devops-capabilities/monitoring-and-observability)
...
In the [continuous delivery](/devops-capabilities/continuous-delivery)
