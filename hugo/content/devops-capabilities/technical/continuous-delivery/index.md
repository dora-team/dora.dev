...
-   Predicts lower levels of burnout (physical, mental, or emotional
    ...
    [job satisfaction](/devops-capabilities/devops-culture-job-satisfaction),
    and better
    [organizational culture](/devops-capabilities/westrum-organizational-culture).
...
-   Impacts culture, leading to greater levels of [psychological safety](https://rework.withgoogle.com/print/guides/5721312655835136/) and a
    more [mission-driven organizational culture](/devops-capabilities/westrum-organizational-culture).
...
to achieve continuous delivery. [Transformational leadership](/devops-capabilities/transformational-leadership) within the
...
-   [Deployment automation](/devops-capabilities/deployment-automation/):
...
-   [Shift left on security](/devops-capabilities/shifting-left-on-security/):
...
-   [A loosely coupled architecture](/devops-capabilities/architecture/):
...
-   [Empowering teams to choose tools](/devops-capabilities/teams-empowered-to-choose-tools/):
...
-   [Continuous integration (CI)](/devops-capabilities/continuous-integration/):
...
-   [Continuous testing](/devops-capabilities/test-automation/):
...
-   [Version control](/devops-capabilities/version-control/):
...
-   [Test data management](/devops-capabilities/test-data-management/):
    ...
    automated tests.
-   [Comprehensive monitoring and observability](/devops-capabilities/monitoring-and-observability/): Allows teams to understand
...
-   [Proactive notifications](/devops-capabilities/proactive-failure-notification/):
    Monitoring system health so that teams can preemptively detect and mitigate
    problems.
-   [Database change management](/devops-capabilities/database-change-management): Database changes don't slow teams down if
    ...
    database changes.
-   [Code maintainability](/devops-capabilities/code-maintainability): Systems and tools that make it easy for developers
