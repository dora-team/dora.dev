...
test.describe("Clear and communicated AI stance capability", () => {
  test.beforeEach(async ({ page }) => {
    await page.goto("/capabilities/clear-and-communicated-ai-stance/");
  });
  ...
  test("has the correct header", async ({ page }) => {
    await expect(page.locator("h1")).toContainText("Clear and communicated AI stance");
  });
