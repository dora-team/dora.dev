...
test.describe("AI-accessible internal data capability", () => {
  test.beforeEach(async ({ page }) => {
    await page.goto("/capabilities/ai-accessible-internal-data/");
  });
  ...
  test("has the correct header", async ({ page }) => {
    await expect(page.locator("h1")).toContainText("AI-accessible internal data");
  });
