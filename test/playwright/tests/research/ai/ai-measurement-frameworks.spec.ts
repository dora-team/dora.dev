...
test.describe('AI measurement frameworks page', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/research/ai/measurement-frameworks/');
  });
  ...
  test('has the correct header.', async ({ page }) => {
    await expect(page.locator('h1').first()).toContainText('DORA Research: Artificial Intelligence');
  });
