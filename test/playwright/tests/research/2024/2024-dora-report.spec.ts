...
test('2024 DORA report page has the correct title.', async ({ page }) => {
  await expect(page).toHaveTitle('DORA | Accelerate State of DevOps Report 2024');
});

test('2024 DORA report page has the correct header.', async ({ page }) => {
...
test('2024 DORA report page has the correct sidebar.', async ({ page }) => {
