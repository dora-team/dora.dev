...
export const heroImages = [
  ...
  // '/guides/how-to-innovate-with-generative-ai/how-to-innovate-with-ai.png', removed while t-shirts are available.
  '/merch/images/dora-fitted-spotlight-yellow.png',
