...
4.  **Propose a Detailed, Actionable Manual Verification Plan:**
    ...
    -   The plan you present to the user **must** follow this format:
        ...
        **Manual Verification Steps:**
        1.  **Start the development server with the command:** `hugo server -D`
...
- [ ] All tests pass
- [ ] Code follows project's code style guidelines (as defined in `code_styleguides/` and in `../.gemini/styleguide.md`)
...
See `../docs/developer-onboarding-guide.md` for setup instructions. Update these instructions as needed.

### Daily Development

```bash
svelte/build.sh # build the Svelte components
hugo server -D # start the local Hugo server with drafts enabled
firebase emulators:start --only hosting # starts a Firebase emulator for local development, useful for validating redirects and other Firebase functionality.
```
