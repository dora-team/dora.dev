<script>
    ...
    import pdf_url_detail from "../assets/pdf/dora-core-v2.1.0-detail.pdf";

    let download_urls = {
        png: {
            summary: png_url_summary,
            detail: png_url_detail,
        },
        pdf: {
            summary: pdf_url_summary,
            detail: pdf_url_detail,
        },
    };
</script>
