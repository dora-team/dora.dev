...
describe('calculateROI', () => {
    it('should calculate ROI correctly with default values', () => {
        ...
        // Total 1 year investment: $8,365,000
        ...
        expect(Math.round(results.total_annual_value)).toBe(11646000);
        expect(Math.round(results.year_1_net_profit)).toBe(3281000);
    ...
    it('should handle zero values for AI costs and negative time saved', () => {
        ...
        expect(results.total_investment).toBe(3300000); // Only J-curve cost remains
    });
});
